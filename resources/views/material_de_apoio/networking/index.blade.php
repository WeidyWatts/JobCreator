                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="flex justify-content-between px-5 py-2">
                                    ...
                                    <a href="#" class="text-download ml-3" data-bs-toggle="modal" data-bs-target="#AdicionarNetworking" >@if(isset($networking))<i class="fa fa-pen"></i> @else <i class="fa fa-upload"></i>@endif </a>
